...
import com.sun.carddemo.util.parseColor
import com.sun.carddemo.util.sp
import java.util.*
...
class CustomTabLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : HorizontalScrollView(context, attrs, defStyleAttr), OnPageChangeListener {
    ...
    private fun obtainAttributes(context: Context, attrs: AttributeSet?) {
        ...
        mIndicatorCornerRadius = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_corner_radius, if (isBlock) (-1f).dp else 0f.dp)
        ...
        indicatorMarginBottom = ta.getDimension(R.styleable.SlidingTabLayout_tl_indicator_margin_bottom, if (isBlock) 7f.dp else 8f.dp)
